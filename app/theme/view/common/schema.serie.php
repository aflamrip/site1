<script type="application/ld+json">
{
    ...
    "trailer": {
        "@type": "VideoObject",
        "name": "<?php echo $Listing['title'].' '.$Selected['season_name'].'Season '.$Selected['episode_name'].'Episode';?>",
        "description": "<?php echo $Listing['description'];?>",
    ...
    "containsSeason": [
        <?php 
			...
			foreach ($Episodes as $Episode) { ?>
            {
                ...
                "name": "<?php echo ($Episode['description'] ? $Episode['description'] : $Episode['name'].'Episode');?>",
                "datePublished": "<?php echo date('Y-m-d');?>T00:00:00+03:00",
